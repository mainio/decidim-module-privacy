...
module Decidim
  ...
  module Authorable
    ...
    included do
      ...
      #
      # Because of the privacy module, calling author here will return nil
      # since it doesn't find the user. To go around that we use the authorable's
      # author_id instead to see if it matches the id of the user passed as a
      # parameter.
