...
# This is exactly the same spec as in the core but it tests the order reminders
# with the privacy module as it affects fetching the user records.
describe Decidim::Budgets::OrderReminderGenerator do
