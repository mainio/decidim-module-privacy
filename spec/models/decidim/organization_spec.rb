...
describe Decidim::Organization, :anonymity do
  ...
  let!(:anonymous_admin) { create(:user, :anonymous, :admin, organization: organization) }
  ...
  let!(:anonymous_user) { create(:user, :anonymous, :user_manager, organization: organization) }
