...
# THIS FILE IS OVERWRITTEN SINCE 0.29 DELEGATES CURRENT_USER THAT IS NOT FOUND BECAUSE OF PRIVACY
# THIS FILE IS NOW REVERTED BACK TO THE VERSION 0.28 CODE
# PART OF THIS CUSTOMIZATION WAS ALSO "registrations_controller_extensions.rb"
# TODO: If possible customize the scope for current user on specific classes
